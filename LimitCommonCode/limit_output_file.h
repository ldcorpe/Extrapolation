...
template<typename T95, typename T1, typename T2, typename T3, typename T4>
group_plotter<T95, T1, T2, T3, T4> make_group_plotter(const variable_binning_builder &binning, const std::string &cl_name, const std::string &sigma_prefix,
	T95 func,
	T1 funcP1S, T2 funcN1S, T3 funcP2S, T4 funcN2S)
{
	return group_plotter<T95, T1, T2, T3, T4>(binning, cl_name, sigma_prefix, func, funcP1S, funcN1S, funcP2S, funcN2S);
}
